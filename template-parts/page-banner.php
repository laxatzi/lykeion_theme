      <section id="hero" class="container pt-5 pb-5">
        <div class="intro pt-sm-5 pt-4 pb-3 px-sm-2 px-3">
          <h1 class="mt-5 mb-1 fw-bold"><?php echo $pagename ?></h1>
          <nav class="breadcrumb-nav">
            <ol class="breadcrumb d-flex">
              ...
              <li class="breadcrumb-item" aria-current="page"><?php echo $pagename ?></li>
            </ol>
          </nav>
        </div>
      </section>
