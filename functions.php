...
// Scripts and Styles
  function edutheme_files() {
    ...
    wp_enqueue_script('toggle-pages-js-file', get_template_directory_uri() . '/js/toggle-pages.js', array('jquery'), '1.0.0', true );
    wp_enqueue_script('toggle-prices-js-file', get_template_directory_uri() . '/js/toggle-prices.js', array('jquery'), '1.0.0', true );
  }
