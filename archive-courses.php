   ...
   <main class="container-fluid">
       ...
       <div class="row">
        <!-- courses headings -->
          <div id="vclasses-headings" class="p-sm-5 ps-0 text-center">
            <h3 class="intro text-center">Our Courses</h3>
            <h2 class="mt-2 mb-3 fw-bold text-center">Courses We Offer</h2>
          </div>
        </div>
    ...
    <!-- end of event list -->
            <div class="read-more btn btn-lg col-lg-3 col-md-4 col-8 my-5" style="margin: 0 auto;">
              <a href="<?php echo site_url('/past-events') ?>" class="link-btn d-flex"
